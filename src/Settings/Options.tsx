...
export default class Options extends Component<Props>{
  ...
  render() {
    ...
    return (
      <PropContain>
        <Button background='#ff5a5a' disabled={false} onClick={()=>{this.clearCanvas(true)}}>
        ...
        <Button background='#4f73f9' disabled={false} onClick={this.downloadImage}>
        ...
        <Button background={isUndo?'#d8d8d8':'#fff'} disabled={isUndo} onClick={this.undoCanvas}>
        ...
        <Button background={isRedo?'#d8d8d8':'#fff'} disabled={isRedo} onClick={this.redoCanvas}>
